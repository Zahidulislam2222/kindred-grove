...
| Supply-chain / CI trust | Locked installs, pinned tools/actions, explicit missing-prerequisite failures | Local pinned workflow/tool configuration prepared; hosted runs not verified |
